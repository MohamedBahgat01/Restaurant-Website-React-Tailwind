...
import Spoone from '../../assets/spoon.png'
  ...
  return (
    <>
      <main>
        ...
        justify-center relative z-10">
            ...
            place-items-center justify-between'>
                ...
                <div className='space-y-3 mt-14 text-center md:text-left md:mt-0'>
                    ...
                    xl:text-8xl font-bold uppercase text-outline text-transparent'>
                        Yummy
                        <img src={Leaf} 
                        alt="" 
                    ...
                    className='text-sm'>
                        ...
                        voluptatum voluptates voluptatem.
                    </motion.p>
                    <motion.button 
                ...
                <div className='relative'>
                    ...
                    transition={{duration:0.8}}
                    src={Spoone} alt="" 
                    className='w-[350px] absolute bottom-[-120px] 
                    -left-16 rotate-[75deg] img-shadow'/>
                    <motion.img 
                    variants={SlideUp(0.4)}
                    initial={{ opacity: 0, rotate : 20, x : 200, y : 100}}
                    whileInView={{ opacity: 1, rotate : 0, x : 0, y : 0}}
                    ...
                    src={Banana} alt="" 
                    className='w-[400px]
                    absolute top-[-30px] right-[-130px] 
                    md:right-[-160px] img-shadow'/>
                </div>
            </div>
        </div>
        {/* Background yellow */}
        ...
        className='w-[2500px] h-[2500px] rounded-3xl bg-ligthYellow 
        absolute top-[-30%] left-[70%] z-0'>
